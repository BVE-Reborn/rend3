use rend3::managers::{VERTEX_POSITION_SLOT, VERTEX_NORMAL_SLOT, VERTEX_TANGENT_SLOT, VERTEX_UV0_SLOT, VERTEX_UV1_SLOT, VERTEX_COLOR_SLOT, VERTEX_JOINT_INDEX_SLOT, VERTEX_JOINT_WEIGHT_SLOT, VERTEX_OBJECT_INDEX_SLOT};
